...
public class TC_004_UpdateRecord extends TestBase {

	@BeforeClass
	public void UpdateEmpData() throws InterruptedException {
		logger.info("**************Started TC_004_UpdateRecord****************");
		RestAssured.baseURI = "http://dummy.restapiexample.com/api/v1";
		httpRequest = RestAssured.given();
		JSONObject reqParam = new  JSONObject();
		reqParam.put("name", "Jane-test");
		reqParam.put("job", "tester");
		//reqParam.put("age", "28");
		httpRequest.header("Content-Type","application/json");
		httpRequest.body(reqParam.toJSONString());
		response = httpRequest.put("/update/" +emp_id);
		System.out.println("http://dummy.restapiexample.com/api/v1"+emp_id);
	...
	public void CheckResponseBody() {
		...
		Assert.assertEquals(responseBody.contains("Jane-test"), true);
	...
	public void TearDown() {
		logger.info("*************Finished TC_004_UpdateRecord*****************");
